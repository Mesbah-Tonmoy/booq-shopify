import { HOLIDAY_COUNTRIES } from 'app/data/holidayData';
import { useHolidaySettings } from 'app/hooks/useHolidaySettings';
      ...
      <div className="bg-[#f6f6f7] rounded-lg p-4 flex flex-col gap-4">
        ...
        >
          ...
          <s-switch
            ...
            onChange={(e) => setCountryEnabled(e.target.checked)}
        ...
        <s-stack direction="block" gap="base">
          {holidays.map((holiday) => (
            <s-stack
              ...
              gap="base"
            >
              <s-text variant="body-md">{holiday.name}</s-text>
              <s-text variant="body-sm" color="subdued">
