...
export function AdvancedSettingsSection({ settings }) {
  ...
  return (
    <s-stack direction="block" gap="base">
      ...
      <s-checkbox
        ...
        onChange={(e) => setShowRedirectOptions(e.target.checked)}
      ...
      {showRedirectOptions && (
        <s-form-field>
          <s-choice-list
            ...
            onChange={(e) => setBookingRedirection(e.target.value)}
          >
      ...
      <s-stack direction="inline" alignItems="center" gap="small-100">
        <s-icon type="note" />
        <s-heading variant="heading-sm">Payment Status</s-heading>
      </s-stack>
      ...
      {paymentStatus === 'Pending' && (
        <s-form-field>
          <s-select
            ...
            onChange={(e) => setPaymentDueTerm(e.target.value)}
          >
      ...
      <s-checkbox
        ...
        onChange={(e) => setUniversalBookingLink(e.target.checked)}
