                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      <s-button size="slim" onClick={selectAllVariants}>
                        Select all
                      </s-button>
                      <s-button size="slim" onClick={clearAllVariants}>
                        Clear all
                      </s-button>
                    </s-stack>
                  </s-stack>
                            ...
                            >
                              ...
                              >
                                <s-checkbox
                                  ...
                                  labelHidden
                                  checked={isSelected}
                                  onChange={(e) => handleVariantToggle(variant)}
                                />
    ...
    <div>
      <div style={{ marginTop: '1.5rem' }}>
        ...
        >
          ...
          <s-button size="slim" onClick={addSlot}>
            Add New Slot
          </s-button>
        </div>
    ...
    <div>
      ...
      <div style={{ marginTop: '1.5rem' }}>
        <s-text variant="heading-sm">
          Day - Start Time - End Time - Add Break
        </s-text>
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      <s-select
                        ...
                        value={slot.start}
                        onChange={(e) =>
                          updateSlot(dayKey, slotIndex, 'start', e.target.value)
                        }
                      >
                    ...
                    <div style={{ flex: 1 }}>
                      <s-select
                        ...
                        value={slot.end}
                        onChange={(e) =>
                          updateSlot(dayKey, slotIndex, 'end', e.target.value)
                        }
                      >
                        <option value="Off">Off</option>
                        <option value="9:00 AM">9:00 AM</option>
          ...
          {allowCancel && (
            <s-stack gap="small-300">
              ...
              <s-stack direction="inline" gap="small-300" alignItems="center">
                ...
                <s-select
                  value={cutoffUnit}
                  onChange={(e) => setCutoffUnit(e.target.value)}
                >
                  <s-option value="Hours">Hours</s-option>
                  <s-option value="Days">Days</s-option>
                </s-select>
...
export function ReviewPublishTabContent({
  ...
  useEffect(() => {
    ...
    const updateLiveData = () => {
      ...
      const serviceType =
        form.querySelector('[name="serviceType"]')?.value || '';
      const locationType =
        form.querySelector('[name="locationType"]')?.value || '';

      // Get price from selected product variants
      const variantIdsInput = form.querySelector(
        '[name="shopifyVariantIds"]'
      )?.value;
      let basePrice = '0.00';
      if (variantIdsInput) {
      ...
      const paymentPrefsInput = form.querySelector(
        '[name="paymentPreferences"]'
      )?.value;
      let paymentType = '';
