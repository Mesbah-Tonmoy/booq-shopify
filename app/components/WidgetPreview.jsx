...
export const WidgetPreview = ({
  ...
  const renderDatePicker = () => {
    ...
    return (
      <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
        <s-text variant="body-sm" fontWeight="semibold" className="block mb-3">
          Select Date & Time
        </s-text>
  ...
  return (
    <div className="bg-white rounded-lg border border-[#e1e3e5] p-6">
      <s-heading
        variant="heading-lg"
        className="mb-6 block text-[#202223] font-semibold"
      >
      ...
      <div className="flex gap-4 mb-8 p-4 bg-[#f6f6f7] rounded-lg">
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          <s-heading
            variant="heading-md"
            className="block text-[#202223] font-semibold"
          >
      ...
      <div>
        <s-text variant="body-md" fontWeight="semibold" className="block mb-4">
          Shop/Archive Grid
        </s-text>
...
WidgetPreview.propTypes = {
  dateTimePickerPosition: PropTypes.string,
  hideEndTime: PropTypes.bool,
  hideSlotAvailabilityCount: PropTypes.bool,
  showPricing: PropTypes.bool,
  showStaffPhotos: PropTypes.bool,
