...
export const action = async ({ request }: Route.ActionArgs) => {
  ...
  if (actionType === 'delete') {
    const serviceCategoryId = getInt(formData, 'serviceCategoryId');
  ...
  // CREATE or UPDATE
  const serviceCategoryId = getString(formData, 'serviceCategoryId');
...
export default function ServiceCategoryPage() {
  ...
  const handleDelete = (serviceCategoryId: number) => {
    ...
    formData.append('serviceCategoryId', String(serviceCategoryId));
        ...
        <s-grid gridTemplateColumns="repeat(12, 1fr)" gap="base">
          <s-grid-item gridColumn="span 5">
            ...
            <s-section>
              ...
              <ServiceCategoryForm
                formData={editingServiceCategory ?? undefined}
              />
            </s-section>
          </s-grid-item>
